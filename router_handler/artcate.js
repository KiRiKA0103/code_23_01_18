...
exports.getArticleCates = (req, res) => {
    const sql = 'select * from ev_article_cate where isDel=0 order by id asc'
...
exports.delCateById = (req, res) => {
    const sql = 'update ev_article_cate set isDel=1 where id=? and isDel=0'
...
exports.getCateById = (req,res) => {
    const sql = 'select * from ev_article_cate where id=? and isDel=0'
